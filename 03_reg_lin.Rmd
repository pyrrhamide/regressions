...
La **régression linéaire** prend comme variable dépendante/à expliquer ($var\_dep$) une variable quantitative continue, telle que la température, le PIB, mon envie de dormir progressive pendant les cours d'EQ...les variables explicatives/indépendantes peuvent être quantitatives ou qualitatives.
...
[^1]:Ecart par rapport à la ligne de régression. On a un nuage de point, une droite qui traverse ces points. La plupart des points ne seront pas sur la droite: la distance entre la droite et le point est le résidu.
[^2]:Du coup on viole la première hypothèse des MCO sur la linéarité des paramètres.
[^3]:Je suis pas sûre de la lecture exacte du coefficient, mais en gros ça fonctionne comme ça.