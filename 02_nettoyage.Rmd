...
# Note: il existe d'autres fonctions du pkg forcats pour accélérer l'ordonnancement des modalités. Je te laisse les découvrir, moi j'ai pas le time, j'ai curling sur gazon.
```
