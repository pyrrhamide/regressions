...
```{r eval=F}
# On met le modèle précédent à jour, en incluant des interactions.
...
# le modèle saturé (interaction d'ordre 3 - toutes les interactions inférieures seront directement inclues)
